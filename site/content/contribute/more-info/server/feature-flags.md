...
For self-hosted releases, typically a flagged feature will be released in an enabled state. That said, you can release a feature to self-hosted disabled, {{< newtabref href="https://github.com/mattermost/mattermost/tree/master/server/public/modelfeature_flags.go#L75" title="it's not unprecedented" >}}.
...
Some [examples are here](https://github.com/mattermost/mattermost/tree/master/server/public/modelfeature_flags.go#L75).
